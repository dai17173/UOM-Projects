...
main()
{
    ...
    //Εισαγουμε τον αριθμο των γραμματων που θα παραχθουν
    printf("Give the number of letters? ");
    scanf("%d", &plithos);

    //Συναρτηση που παραγει τυχαια γραμματα και τα εισαγει σε κενο ΔΔΑ
    GenerateBST(&ARoot, plithos);

    //Εμφανιζει τα στοιχεια του ΔΔΑ
    printf("*****Inorder traversal of BST*****\n");
    InorderTraversal(ARoot);
    printf("\n");


        // TO DDA DEN PERILAMBANEI OLA TA GRAMMATA POY DIMIOYRGOYNTAI APO TIN SINARTISI
        // GT DEN GINETE NA EISAXTEI TO IDIO GRAMMA PANW APO 2 FORES!!
...
//Υλοποιηση Συναρτησης GenerateBST
void GenerateBST(BinTreePointer *Root, int n)
{
    char x;
