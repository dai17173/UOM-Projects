#include <stdio.h>
#define QueueLimit 53 //το όριο μεγέθους της ουράς
...
main()
{
    ...
    //Γεμιζουμε την ουρα με τους περιττους αριθμους 1 εως 100
    for(int i=1; i<100; i+=2)
    {
        AddQ(&AQueue,i);
    }

    // Κληση συναρτησης DisplayQA
    DisplayQA(&AQueue);
    // Κληση συναρτησης DisplayQΒ
    DisplayQB(AQueue);
...
//Υλοποιηση συναρτησης DisplayQA
void DisplayQA(QueueType *Q)
{
...
//Υλοποιηση συναρτησης DisplayQB
